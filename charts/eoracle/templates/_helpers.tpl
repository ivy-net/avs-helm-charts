...
{{- define "eoracleRegister.labels" -}}
helm.sh/chart: {{ include "eoracle.chart" . }}
{{ include "eoracleRegister.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
Selector labels
*/}}
{{- define "eoracleRegister.selectorLabels" -}}
app.kubernetes.io/name: {{ include "eoracle.name" . }}-register
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
